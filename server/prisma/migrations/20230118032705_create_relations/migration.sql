...
INSERT INTO "new_habit_week_days" ("habit_id", "id", "weekday_id") SELECT "habit_id", "id", "weekday_id" FROM "habit_week_days";
DROP TABLE "habit_week_days";
ALTER TABLE "new_habit_week_days" RENAME TO "habit_week_days";
CREATE UNIQUE INDEX "habit_week_days_habit_id_weekday_id_key" ON "habit_week_days"("habit_id", "weekday_id");
